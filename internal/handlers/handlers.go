...
// AdminNewReservations shows all new reservations in amdmin tool
...
// AdminShowReservation shos the reservation in the admin tool
...
func (m *Repository) AdminPostShowReservation(w http.ResponseWriter, r *http.Request) {
	...
	err = m.DB.UpdateReseravtion(res)
	if err != nil {
		helpers.ServerError(w, err)
		return
	}
